...
const INCENTIVE_DEFAULTS = {
    ...
    wearables: { models: [{name:"Watch Ultra / 8 Cls / 8", rate:1200, keys:"ultra,classic,watch8,watch 8"},{name:"Other Watches", rate:800, keys:"watch"},{name:"Buds3 Pro", rate:600, keys:"buds3 pro"},{name:"Buds3 / FE", rate:500, keys:"buds3,buds fe"},{name:"Other Buds", rate:400, keys:"buds"},{name:"Galaxy Ring", rate:0, keys:"ring"}] },
    carePlus: { slabs: [{min:100000,rate:400,label:"> 1L"},{min:70000,rate:350,label:"70k - 1L"},{min:40000,rate:300,label:"40k - 70k"},{min:30000,rate:200,label:"30k - 40k"},{min:20000,rate:120,label:"20k - 30k"},{min:10000,rate:100,label:"10k - 20k"},{min:0,rate:50,label:"< 10k"}], kickers: { ff7:{l:400,h:600}, s25:{l:300,h:500} } },
    notePC: { models: [{name:"GB5 Pro / 360", rate:3000}, {name:"GB5 360 / GB4 Pro", rate:2500}, {name:"GB5 / GB3 360", rate:1750}, {name:"GB4 Edge / Go", rate:1250}, {name:"Other", rate:1000}] },
    bundles: { models: [{name:"Wr+Hr", rate:750}, {name:"Wearable", rate:400}, {name:"Hearable", rate:250}, {name:"Wr+Hr+Acc", rate:1000}, {name:"Acc", rate:100}] },
    accessories: { slabs: [{min:4, rate:3000}, {min:3, rate:2000}, {min:2, rate:1000}, {min:1, rate:500}], target: 0, achieved: 0 },
    misc: { amount: 0 },
