...
const INCENTIVE_DEFAULTS = {
    ...
    wearables: { items: [{name:"Watch Ultra / 8 Cls / 8", rate:1200, keys:"ultra,classic,watch8,watch 8"},{name:"Other Watches", rate:800, keys:"watch"},{name:"Buds3 Pro", rate:600, keys:"buds3 pro"},{name:"Buds3 / FE", rate:500, keys:"buds3,buds fe"},{name:"Other Buds", rate:400, keys:"buds"},{name:"Galaxy Ring", rate:0, keys:"ring"}] },
    ...
    notePC: { items: [{name:"GB5 Pro / 360", rate:3000}, {name:"GB5 360 / GB4 Pro", rate:2500}, {name:"GB5 / GB3 360", rate:1750}, {name:"GB4 Edge / Go", rate:1250}, {name:"Other", rate:1000}] },
    bundles: { items: [{name:"Wr+Hr", rate:750}, {name:"Wearable", rate:400}, {name:"Hearable", rate:250}, {name:"Wr+Hr+Acc", rate:1000}, {name:"Acc", rate:100}] },
